...
export function runtimeRequest(method: RequestMethod, path: string, body?: unknown): RuntimeResponse {
  ...
  if (pathname === '/products' && method === 'POST') {
    const payload = body as Pick<Product, 'storeId' | 'name' | 'category' | 'price'>;
